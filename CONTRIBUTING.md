...
See <https://devshell.vercel.app/cheatsheet-styles> for a reference on styling.
...
The site devshell.vercel.app is backed by CloudFlare. Updates will take 2 days to propagate to the website by default. To make sure recent changes will propagate, use this helper script. It will give instructions on how manual selective cache purging can be done.
...
```
React cheatsheet - devshell.vercel.app
------------------------------
https://devshell.vercel.app/react ▼
